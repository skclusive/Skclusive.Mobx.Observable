...
namespace Skclusive.Mobx.Observable
{
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
    {
        ...
        /// A dictionary that remembers the order that keys were first inserted. If a new entry overwrites an existing entry, the original insertion position is left unchanged. Deleting an entry and reinserting it will move it to the end.
        /// </summary>
        public OrderedDictionary(IDictionary<TKey, TValue> dictionary = null)
            : this()
        {
        ...
        public OrderedDictionary(IEqualityComparer<TKey> comparer) : this()
        {
            fDictionary = new Dictionary<TKey, TValue>(comparer);
        }

        public OrderedDictionary(int capacity) : this()
        {
            fDictionary = new Dictionary<TKey, TValue>(capacity);
        }

        public OrderedDictionary(int capacity, IEqualityComparer<TKey> comparer) : this()
        {
            fDictionary = new Dictionary<TKey, TValue>(capacity, comparer);
        }

        public OrderedDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) : this()
        {
            fDictionary = new Dictionary<TKey, TValue>(comparer);
